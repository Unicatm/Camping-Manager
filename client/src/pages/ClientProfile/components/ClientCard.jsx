...
export default function ClientProfile({ client }) {
  return (
    <div className="bg-white rounded-xl p-6 shadow-sm shadow-slate-200 w-full h-fit border-[1px] border-slate-300 lg:col-start-1 lg:col-end-2 lg:row-start-1 lg:row-end-6 xl:col-start-1 xl:col-end-2 xl:row-start-1 xl:row-end-6">
